...
?>
    ...
    <div>
				<form method="post" action="comment_modify_ok.php">
					<input type="hidden" name="rno" value="<?php echo $comment['idx']; ?>" /><input type="hidden" name="bno" value="<?php echo $number; ?>">
					<textarea name="contents" class=""><?php echo $comment['content']; ?></textarea>
